...
<head>
    ...
    <script>
        window.addEventListener('load', function () {
            // Clear form data when the page loads to prevent resubmission data from filling the form
...
<script>
    document.getElementById('registerForm').reset(); // Clears the form fields on page load
</script>
